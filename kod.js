window.onload = function(){
	...
	var x, y;
    var kod = [], stan = [], i, n_kod = 4, liczba_wierszy = 8, j, podpowiedz = [];
    var xp = 310, yp = 40;
...
*/
    ...
    function plansza()
    {
        ...
        ctx.fillRect(xp,yp,400,500);
        ctx.rect(xp,yp,400,500);
	...
	for(j=0;j<n_kod;j++)
	{
	    ...
	    {	
			if(i>=poz)
			{
				ctx.rect(xp+40+220+j*30,yp+450+8-i*55,15,15);
			}
			else
			{
				...
				{
	                    		ctx.fillRect(xp+40+220+j*30,yp+450+8-i*55,15,15);
				}
		            	ctx.strokeStyle = "#50330e";
			    	ctx.rect(xp+40+220+j*30,yp+450+8-i*55,15,15);
			}
